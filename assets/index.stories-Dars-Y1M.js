import{l as s,c as i}from"./showdown-BvUchQxB.js";const c={title:"Phaser Virtual Joystick",parameters:{docs:{description:{component:"Examples of how to install and use Phaser Virtual Joystick"}}}},n=()=>{const e=document.getElementById("phaser-virtual-joystick-index");if(e)return e;const t=document.createElement("div");return t.id="phaser-virtual-joystick-index",t.style.padding="1rem",t.style.fontFamily="sans-serif",t},a=`
...
`,o={render:()=>{s();const e=n();return i(a).then(t=>{e.innerHTML=t}),e}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  render: (): HTMLElement => {
    loadShowdown();
...
}`,...o.parameters?.docs?.source}}};const l=["Index"];export{o as Index,l as __namedExportsOrder,c as default};
