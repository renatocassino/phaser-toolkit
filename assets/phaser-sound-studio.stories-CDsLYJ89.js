...
`,r={MOUSE_HOVER:"mouse-hover",MOUSE_CLICK:"mouse-click"},g={HUD:"hud"},w={[r.MOUSE_HOVER]:{channel:g.HUD,preload:!0,path:"/sounds/ui-pop.m4a",loop:!1},[r.MOUSE_CLICK]:{channel:g.HUD,preload:!0,path:"/sounds/click.mp3",loop:!1}};class B extends K{constructor(){super("preview")}preload(){c(this).loadAll(this)}create(){this.cameras.main.setBackgroundColor(this.pw.color.rgb("slate-900"));const e=new p({scene:this,x:this.cameras.main.centerX,y:this.cameras.main.centerY,backgroundColor:"blue-500",textColor:"white",text:"Click me",onClick:()=>{c(this).play(this,r.MOUSE_CLICK)}});this.add.existing(e)}}const v={title:"Phaser Sound Studio/Components/Play Sound",parameters:{docs:{description:{component:"Column is a layout container that stacks children vertically with configurable gap and alignment."}}}},i={render:()=>{const a=document.createElement("div");return a.id=l,a},play:async()=>{await S(),await f(3),C(l,{type:E.AUTO,width:800,height:600,backgroundColor:P.rgb("slate-900"),parent:document.getElementById(l),scene:[B],plugins:{global:[{key:d,plugin:m,mapping:d,start:!0,data:{theme:L}},{key:u,plugin:_,mapping:u,start:!0,data:{soundList:w,channels:["hud"]}}]}})}};i.parameters={docs:{autoplay:!0,story:{inline:!1},source:{code:b}}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  render: () => {
...
}`,...i.parameters?.docs?.source}}};const k=["Default"];export{i as Default,k as __namedExportsOrder,v as default};
