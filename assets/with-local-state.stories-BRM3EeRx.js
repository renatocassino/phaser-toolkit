import{p as S,F as a,C as s,c as w,n as b,a as f,d as O}from"./create-game-IT2NM2Nb.js";import{R as C,T as l,a as m,H as y}from"./plugin-hGH1kwtW.js";import{w as h}from"./with-local-state-Dc8nv1dP.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./webfontloader-DxEgiKE1.js";import"./with-state-def-B07kmtJ8.js";class T extends S.Scene{constructor(){super("PreviewScene")}preload(){}create(){const n=h(this,"localState",5);n.set(5);const t=this.cameras.main.centerX,e=this.cameras.main.centerY;this.add.text(t,e-180,"Phaser Wind - Scene 1",{color:s.rgb("slate-200"),align:"center",fontSize:a.px("6xl")}).setOrigin(.5,.5),this.add.text(t,e-120,"Code: withLocalState<number>(this, 'localState', 5);").setOrigin(.5,.5);const r=this.add.text(t,e-100,n.get().toString(),{color:s.rgb("slate-200"),align:"center",fontSize:a.px("6xl")}).setOrigin(.5,.5),c=new C({scene:this,x:t,y:e,gap:16,align:"center",children:[new l({scene:this,x:t,y:e-100,text:"-",fontSize:"xl",backgroundColor:"gray-600",onClick:()=>{n.set(n.get()-1)}}),r,new l({scene:this,x:t,y:e-100,text:"+",fontSize:"xl",backgroundColor:"gray-600",onClick:()=>{n.set(n.get()+1)}})]}),i=n.on("change",()=>{r.setText(n.get().toString())});this.add.existing(c),this.add.text(t,e+100,`Local State: ${n.get()}`,{color:s.rgb("slate-300"),align:"center",fontSize:a.px("lg")}).setOrigin(.5,.5),this.add.text(t,e+100,"Go to Scene 2",{color:s.rgb("slate-200"),align:"center",fontSize:a.px("2xl"),backgroundColor:"#4A5568",padding:{x:20,y:10}}).setOrigin(.5).setInteractive({useHandCursor:!0}).on("pointerdown",()=>{i(),this.scene.start("PreviewScene2")})}}class v extends S.Scene{constructor(){super("PreviewScene2")}preload(){}create(){const n=h(this,"localState",5),t=this.cameras.main.centerX,e=this.cameras.main.centerY;this.add.text(t,e-180,"Phaser Wind - Scene 2",{color:s.rgb("slate-200"),align:"center",fontSize:a.px("6xl")}).setOrigin(.5,.5),this.add.text(t,e-120,"Code: withLocalState<number>(this, 'localState', 5);").setOrigin(.5,.5),this.add.text(t,e-80,`Local State value: ${n.get()}`,{color:s.rgb("slate-300"),align:"center",fontSize:a.px("lg")}).setOrigin(.5,.5),this.add.text(t,e+20,"Note that in this scene, the localState did not bring the value from the other scene. The initial value is 5, and in this scene back to 5.",{color:s.rgb("slate-400"),align:"center",fontSize:a.px("lg"),wordWrap:{width:600}}).setOrigin(.5,.5)}}class P extends S.Scene{changeLogText;constructor(){super("PreviewSceneOnChange")}preload(){}create(){const n=h(this,"onChangeState",0),t=h(this,"onChangeCount",0),e=this.cameras.main.centerX,r=this.cameras.main.centerY;this.add.text(e,r-200,"Phaser Hooks - On Change Example",{color:s.rgb("slate-200"),align:"center",fontSize:a.px("3xl")}).setOrigin(.5,.5),this.add.text(e,r-130,`Code:
