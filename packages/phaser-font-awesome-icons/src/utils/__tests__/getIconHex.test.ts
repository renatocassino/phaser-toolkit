...
import { getIconHex } from '../getIconHex';
...
describe('getIconHex', () => {
    ...
    describe.each([
        ...
        'null-value',
        'undefined-value'
    ])('error cases for %s', (testCase) => {
        it('should handle invalid input', () => {
            let input: IconKey | null | undefined | string;
            switch (testCase) {
                case 'empty-string': input = ''; break;
                case 'null-value': input = null; break;
                case 'undefined-value': input = undefined; break;
            }
