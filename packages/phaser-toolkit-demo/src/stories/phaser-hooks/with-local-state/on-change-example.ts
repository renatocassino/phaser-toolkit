...
export class PreviewSceneOnChange extends Scene {
    ...
    create(): void {
        ...
        this.add
            .text(centerX, centerY - 200, 'Phaser Hooks - On Change Example', {
...
export class PreviewScene2OnChange extends Scene {
    ...
    create(): void {
        ...
        this.add.text(centerX, centerY - 160, 'Same hook, but different scene with another state').setOrigin(0.5, 0.5);
