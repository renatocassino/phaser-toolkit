...
(function (r, o) {
  (function (s, p) {
    ...
    function q(e) {
      var t, n;
      return (n = (t = $.exec(e)) === null || t === void 0 ? void 0 : t[0]) !==
        null && n !== void 0
        ? n
        : null;
    }
...
`
      ...
      JsdocTypeObject: (e, t) => {
        ...
        for (const a of e.elements)
          ...
          a.type !== 'JsdocTypeJsdocObjectField'
            ? n.fields.push({ type: 'FieldType', key: t(a), value: void 0 })
            : n.fields.push(t(a));
        return n;
      },
      JsdocTypeObjectField: (e, t) => {
    ...
    const rn = {
      ...
      JsdocTypeFunction: (e, t) => {
        ...
        return (
          n.this !== void 0 ? (a.this = t(n.this)) : e.arrow || (a.this = null),
          n.new !== void 0 && (a.new = t(n.new)),
