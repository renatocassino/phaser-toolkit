...
- Depth/Z-layers nomeados — base, content, overlay, modal, tooltip. Em jogos isso é mais crítico do que na web.
...
- Positioning helpers — pw.pos.center(), pw.pos.topRight(padding), pw.pos.safeArea(). Todo jogo reescreve isso.
