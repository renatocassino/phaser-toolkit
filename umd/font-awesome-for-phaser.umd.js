(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.fontAwesomeForPhaser = {}, global.Phaser, global.WebFont));
})(this, (function (exports, Phaser, WebFont) { 'use strict';
    ...
    ***************************************************************************** */
     ...
     */
    var convertToFontAwesome = function (codeIcon) {
        return String.fromCharCode(parseInt(codeIcon, 16));
    };

    var getIconChar = function (key) {
        if (!fontIcons[key]) {
            throw new Error("Icon ".concat(key, " not found in fontIcons"));
        }
        return convertToFontAwesome(fontIcons[key].hexCode);
    };
    var getIconStyles = function (key) {
        if (!fontIcons[key]) {
            throw new Error("Icon ".concat(key, " not found in fontIcons"));
        }
    ...
    var IconText = /** @class */ (function (_super) {
        ...
        function IconText(_a) {
            var scene = _a.scene, x = _a.x, y = _a.y, icon = _a.icon, _b = _a.size, size = _b === void 0 ? 16 : _b, _c = _a.style, style = _c === void 0 ? {} : _c, _d = _a.iconStyle, iconStyle = _d === void 0 ? 'solid' : _d;
            var _this = _super.call(this, scene, x, y, getIconChar(icon), __assign({ fontSize: "".concat(size, "px") }, style)) || this;
            _this.currentIconStyle = 'solid';
            _this.icon = icon;
            _this.currentIconStyle = iconStyle;
            _this.applyIconStyle(_this.currentIconStyle);
            _this.setOrigin(0.5, 0.5);
            return _this;
        }
        IconText.prototype.setIcon = function (icon, opts) {
            this.setText(getIconChar(icon));
            this.icon = icon;
            if (opts === null || opts === void 0 ? void 0 : opts.iconStyle) {
                this.applyIconStyle(opts.iconStyle);
            }
        };
        IconText.prototype.setIconStyle = function (iconStyle) {
            this.applyIconStyle(iconStyle);
        };
        IconText.prototype.getIconStyle = function () {
            return this.currentIconStyle;
        };
        IconText.prototype.getIcon = function () {
            return this.icon;
        };
        IconText.prototype.applyIconStyle = function (iconStyle) {
            var newIconStyle = iconStyle;
            var availableStyles = getIconStyles(this.icon);
            if (!availableStyles.has(iconStyle)) {
                var newStyle = __spreadArray([], availableStyles, true)[0];
                // eslint-disable-next-line no-console
                console.warn("Icon ".concat(this.icon, " does not support style \"").concat(iconStyle, "\", using \"").concat(newStyle, "\" instead. Available styles: ").concat(Array.from(__spreadArray([], availableStyles, true).map(function (style) { return "\"".concat(style, "\""); })).join(', ')));
    ...
    var ensureFA7Ready = function () { return __awaiter(void 0, void 0, void 0, function () {
        var loads;
        ...
        return new Promise(function (resolve, reject) {
            WebFont.load({
                custom: {
                    ...
                    urls: [
                        url !== null && url !== void 0 ? url : 'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/7.0.0/css/all.min.css',
                    ],
                },
                active: function () {
                    ensureFA7Ready().then(function () {
                        resolve();
                    }).catch(function () {
                        reject();
                    });
