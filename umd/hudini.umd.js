(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('phaser'), require('lodash.merge'), require('webfontloader')) :
    typeof define === 'function' && define.amd ? define(['exports', 'phaser', 'lodash.merge', 'webfontloader'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.hudini = {}, global.Phaser, global._.merge));
})(this, (function (exports, Phaser$1, merge) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var getPWFromScene = function (scene) {
        return scene.pw;
    };
    ...
    var Card = /** @class */ (function (_super) {
         ...
         * @returns this for chaining
         */
        Card.prototype.setBackgroundColor = function (color) {
         ...
         * @returns this for chaining
         */
        Card.prototype.setBorderRadius = function (borderRadius) {
            this.borderRadiusPx =
                typeof borderRadius === 'number'
                    ? borderRadius
         ...
         * @returns this for chaining
         */
        Card.prototype.setMargin = function (margin) {
            this.marginPx =
                typeof margin === 'number'
                    ? margin
         ...
         * @returns this for chaining
         */
        Card.prototype.setChild = function (child) {
            // Remove old child
            if (this.child) {
         ...
         */
        Card.prototype.createBackgroundGraphics = function (scene, width, height) {
         ...
         */
        Card.prototype.setupContainer = function () {
        ...
        Card.prototype.layout = function () {
            ...
            var childBounds = this.child.getBounds();
            // Calculate card dimensions with margin
            var cardWidth = childBounds.width + this.marginPx * 2;
            var cardHeight = childBounds.height + this.marginPx * 2;
            // Check if child has origin property and get its current origin
            var childOrigin = this.getChildOrigin();
         ...
         */
        Card.prototype.getChildOrigin = function () {
            ...
            if (this.child &&
                ...
                var origin_1 = this.child.getOrigin();
                if (origin_1 &&
                    typeof origin_1.x === 'number' &&
                    typeof origin_1.y === 'number') {
                    return { x: origin_1.x, y: origin_1.y };
                }
            }
            return null;
        };
         ...
         */
        Card.prototype.calculateChildX = function (cardWidth, childWidth, childOrigin) {
            if (this.child && childOrigin) {
                ...
                var originOffsetX = childWidth * childOrigin.x;
         ...
         */
        Card.prototype.calculateChildY = function (cardHeight, childHeight, childOrigin) {
            if (childOrigin) {
                // Consider child's origin for centering
                ...
                var originOffsetY = childHeight * childOrigin.y;
        ...
        Card.prototype.measureChild = function (child) {
            var w = getDisplayWidthOf(child);
            var h = getDisplayHeightOf(child);
            return { w: w, h: h };
        };
        /**
         * Draws the background graphics
         */
        Card.prototype.drawBackground = function (w, h) {
    ...
    var DEFAULT_ICON = 'spinner';
    var DEFAULT_COLOR = 'blue';
    var ROTATIONS_PER_SECOND = 2;
    var ONE_SECOND = 1000;
    var CircularProgress = /** @class */ (function (_super) {
        __extends(CircularProgress, _super);
        function CircularProgress(_a) {
            var scene = _a.scene, x = _a.x, y = _a.y, _b = _a.icon, icon = _b === void 0 ? DEFAULT_ICON : _b, size = _a.size, _c = _a.color, color = _c === void 0 ? DEFAULT_COLOR : _c, _d = _a.rotationsPerSecond, rotationsPerSecond = _d === void 0 ? ROTATIONS_PER_SECOND : _d;
            var _this = _super.call(this, scene, x, y) || this;
            _this.isSpinning = true;
            _this.pw = getPWFromScene(scene);
            _this.rotationSpeed = rotationsPerSecond;
            var sizePx = typeof size === 'number'
                ? size
                : _this.pw.fontSize.px(size !== null && size !== void 0 ? size : 'md');
            _this.createIconText(scene, icon, sizePx, color);
            _this.setupContainer();
            _this.startSpinning();
            return _this;
        }
         ...
         */
        CircularProgress.prototype.start = function () {
            if (!this.isSpinning) {
         ...
         */
        CircularProgress.prototype.stop = function () {
         ...
         */
        CircularProgress.prototype.setRotationsPerSecond = function (rotationsPerSecond) {
         ...
         */
        CircularProgress.prototype.setIcon = function (icon) {
         ...
         */
        CircularProgress.prototype.setColor = function (color) {
         ...
         */
        CircularProgress.prototype.setSize = function (size) {
            var sizePx = typeof size === 'number'
                ? size
                : this.pw.fontSize.px(size);
            this.iconText.setFontSize("".concat(sizePx, "px"));
            return this;
        };
        Object.defineProperty(CircularProgress.prototype, "spinning", {
            /**
        ...
        CircularProgress.prototype.setupContainer = function () {
            this.add([this.iconText]);
        };
        CircularProgress.prototype.startSpinning = function () {
            var _this = this;
            if (!this.isSpinning)
                return;
            var duration = ONE_SECOND / this.rotationSpeed;
         ...
         */
        CircularProgress.prototype.destroy = function () {
            this.stop();
    ...
    var BUTTON_SCALE$1 = 2.2;
    var CENTER_OFFSET$1 = 1.1;
    var FlatIconButton = /** @class */ (function (_super) {
        ...
        function FlatIconButton(_a) {
            ...
            _this.borderRadiusPx =
                typeof borderRadius === 'number'
                    ...
                    : _this.pw.radius.px((borderRadius !== null && borderRadius !== void 0 ? borderRadius : 'md'));
            _this.backgroundColorValue = Color.rgb(backgroundColor);
            _this.iconColorValue = Color.rgb(iconColor);
            _this.backgroundOpacityValue = backgroundOpacity;
            _this.iconOpacityValue = iconOpacity;
            _this.createBackgroundSprite(scene);
            _this.createIconText(scene, icon, iconStyle);
            _this.setupContainer();
            _this.setupInteractivity(onClick);
            return _this;
        }
        // API: colors
        FlatIconButton.prototype.setBackgroundColor = function (color) {
            this.backgroundColorValue = Color.rgb(color);
            this.regenerateBackgroundTexture();
            return this;
        };
        FlatIconButton.prototype.setIconColor = function (color) {
        ...
        // API: opacity
        FlatIconButton.prototype.setBackgroundOpacity = function (opacity) {
            this.backgroundOpacityValue = Math.max(0, Math.min(1, opacity));
            this.backgroundSprite.setAlpha(this.backgroundOpacityValue);
            return this;
        };
        FlatIconButton.prototype.setIconOpacity = function (opacity) {
            this.iconOpacityValue = Math.max(0, Math.min(1, opacity));
            this.iconText.setAlpha(this.iconOpacityValue);
            return this;
        };
        // API: radius
        FlatIconButton.prototype.setBorderRadius = function (borderRadius) {
            var newRadiusPx = typeof borderRadius === 'number'
                ? borderRadius
        ...
        // API: icon
        FlatIconButton.prototype.setIcon = function (icon, opts) {
            this.iconText.setIcon(icon, opts);
            return this;
        };
        FlatIconButton.prototype.setButtonSize = function (size) {
            this.baseSizePx =
                typeof size === 'number'
                    ? size
                    : this.pw.fontSize.px(size !== null && size !== void 0 ? size : 'md');
            this.iconText.setFontSize("".concat(this.baseSizePx, "px"));
            this.updateSize();
            this.regenerateBackgroundTexture();
            return this;
        };
        FlatIconButton.prototype.updateSize = function () {
            this.width = this.baseSizePx * BUTTON_SCALE$1;
            this.height = this.baseSizePx * BUTTON_SCALE$1;
        };
        FlatIconButton.prototype.createBackgroundSprite = function (scene) {
            var textureKey = this.createBackgroundTexture(scene);
            this.backgroundSprite = scene.add.sprite(0, 0, textureKey);
            this.backgroundSprite.setOrigin(0.5, 0.5);
            this.backgroundSprite.setAlpha(this.backgroundOpacityValue);
        };
        FlatIconButton.prototype.regenerateBackgroundTexture = function () {
            var textureKey = this.createBackgroundTexture(this.scene);
            this.backgroundSprite.setTexture(textureKey);
            this.backgroundSprite.setAlpha(this.backgroundOpacityValue);
        };
        FlatIconButton.prototype.createBackgroundTexture = function (scene) {
            var size = this.baseSizePx;
            var textureKey = "flatIconButton_".concat(this.backgroundColorValue, "_").concat(this.borderRadiusPx, "_").concat(size);
            var textureSize = size * BUTTON_SCALE$1; // match icon-button scale for consistency
            var centerX = size * CENTER_OFFSET$1;
            var centerY = size * CENTER_OFFSET$1;
            var graphics = scene.add.graphics();
            graphics.fillStyle(Color.hex(this.backgroundColorValue), 1);
            var side = size * 2;
            var radius = Math.min(this.borderRadiusPx, side / 2);
        ...
        FlatIconButton.prototype.createIconText = function (scene, icon, iconStyle) {
            this.iconText = new IconText({
                scene: scene,
                x: 0,
                y: 0,
        ...
        FlatIconButton.prototype.setupContainer = function () {
            this.add([this.backgroundSprite, this.iconText]);
        };
        FlatIconButton.prototype.setupInteractivity = function (onClick) {
            var _this = this;
            this.backgroundSprite.setInteractive({ useHandCursor: true });
            this.backgroundSprite.on('pointerdown', function () {
                _this.scene.tweens.add({
                    targets: [_this.backgroundSprite, _this.iconText],
                    y: CLICK_OFFSET$2,
                    duration: durations$2.click,
                    ease: 'Linear',
                });
            });
            this.backgroundSprite.on('pointerup', function () {
                _this.scene.tweens.add({
                    targets: [_this.backgroundSprite, _this.iconText],
                    y: 0,
                    duration: durations$2.click,
        ...
        Object.defineProperty(FlatIconButton.prototype, "interactive", {
            /**
             * Gets the interactive sprite of the icon button
             * @returns The interactive sprite
             */
            get: function () {
                var _a = this.backgroundSprite, on = _a.on, off = _a.off, setInteractive = _a.setInteractive, once = _a.once;
                return {
         ...
         */
        FlatIconButton.prototype.getBounds = function (output) {
            var width = this.baseSizePx * BUTTON_SCALE$1;
            var height = this.baseSizePx * BUTTON_SCALE$1;
            if (output) {
    ...
    var BUTTON_SCALE = 2.2;
    var CENTER_OFFSET = 1.1;
    var SHADOW_OFFSET$1 = 4;
    var SHADOW_OPACITY$2 = 0.1;
    var MAIN_SHADOW_OPACITY = 0.9;
    var INNER_OVERLAY_OPACITY = 0.7;
    var HOVER_SCALE$1 = 1.07;
    var CLICK_OFFSET$1 = 2;
    var MAIN_OVERLAY_SCALE = 0.9;
    var INNER_OVERLAY_SCALE = 0.7;
    var IconButton = /** @class */ (function (_super) {
        __extends(IconButton, _super);
        function IconButton(_a) {
            var scene = _a.scene, x = _a.x, y = _a.y, icon = _a.icon, size = _a.size, color = _a.color, onClick = _a.onClick, borderRadius = _a.borderRadius;
            var _this = _super.call(this, scene, x, y) || this;
            _this.pw = getPWFromScene(scene);
            var sizePx = typeof size === 'number'
                ? size
            ...
            _this.borderRadiusPx =
                typeof borderRadius === 'number'
                    ? borderRadius
                    : _this.pw.radius.px((borderRadius !== null && borderRadius !== void 0 ? borderRadius : 'full'));
            _this.createShadowSprite(scene, sizePx, baseColor, _this.borderRadiusPx);
            _this.createBackgroundSprite(scene, sizePx, baseColor, _this.borderRadiusPx);
            _this.createIconText(scene, icon, sizePx, baseColor);
            _this.setupContainer();
            _this.setupInteractivity(onClick);
            return _this;
        }
        IconButton.prototype.setBorderRadius = function (borderRadius) {
            var newRadiusPx = typeof borderRadius === 'number'
                ? borderRadius
                : this.pw.radius.px(borderRadius);
            if (this.borderRadiusPx === newRadiusPx)
            ...
            var shadowTexture = this.createShadowTexture(this.scene, this.sizePx, this.baseColor, this.borderRadiusPx);
            var backgroundTexture = this.createBackgroundTexture(this.scene, this.sizePx, this.baseColor, this.borderRadiusPx);
            this.shadowSprite.setTexture(shadowTexture);
            this.backgroundSprite.setTexture(backgroundTexture);
            return this;
        };
        IconButton.prototype.setButtonSize = function (size) {
            this.sizePx =
                typeof size === 'number'
                    ? size
                    : this.pw.fontSize.px(size !== null && size !== void 0 ? size : 'md');
            this.iconText.setFontSize("".concat(this.sizePx, "px"));
            this.updateSize();
            var shadowTexture = this.createShadowTexture(this.scene, this.sizePx, this.baseColor, this.borderRadiusPx);
            var backgroundTexture = this.createBackgroundTexture(this.scene, this.sizePx, this.baseColor, this.borderRadiusPx);
            this.shadowSprite.setTexture(shadowTexture);
        ...
        IconButton.prototype.createShadowSprite = function (scene, size, baseColor, borderRadiusPx) {
            var shadowTexture = this.createShadowTexture(scene, size, baseColor, borderRadiusPx);
            this.shadowSprite = scene.add.sprite(1, SHADOW_OFFSET$1, shadowTexture);
            this.shadowSprite.setOrigin(0.5, 0.5);
        };
        IconButton.prototype.createShadowTexture = function (scene, size, baseColor, borderRadiusPx) {
            var textureKey = "iconButton_shadow_r".concat(borderRadiusPx, "_").concat(baseColor, "_").concat(size);
            var textureSize = size * BUTTON_SCALE;
            var centerX = size * CENTER_OFFSET;
            var centerY = size * CENTER_OFFSET;
            var graphics = scene.add.graphics();
            var sideOuter = size * 2 * CENTER_OFFSET;
            var side = size * 2;
            var radiusOuter = Math.min(borderRadiusPx, sideOuter / 2);
            var radius = Math.min(borderRadiusPx, side / 2);
            ...
            graphics.fillStyle(Color.hex("".concat(baseColor, "-900")), MAIN_SHADOW_OPACITY);
            graphics.fillRoundedRect(centerX - side / 2, centerY - CLICK_OFFSET$1 - side / 2, side, side, radius);
            graphics.generateTexture(textureKey, textureSize, textureSize);
            graphics.destroy();
            return textureKey;
        };
        IconButton.prototype.updateSize = function () {
            this.setSize(this.sizePx * BUTTON_SCALE, this.sizePx * BUTTON_SCALE);
        };
        IconButton.prototype.createBackgroundSprite = function (scene, size, baseColor, borderRadiusPx) {
            var backgroundTexture = this.createBackgroundTexture(scene, size, baseColor, borderRadiusPx);
            this.backgroundSprite = scene.add.sprite(1, 0, backgroundTexture);
            this.backgroundSprite.setOrigin(0.5, 0.5);
        };
        IconButton.prototype.createBackgroundTexture = function (scene, size, baseColor, borderRadiusPx) {
            var textureKey = "iconButton_r".concat(borderRadiusPx, "_").concat(baseColor, "_").concat(size);
            var textureSize = size * BUTTON_SCALE;
            var centerX = size * CENTER_OFFSET;
            var centerY = size * CENTER_OFFSET;
            var graphics = scene.add.graphics();
            var side = size * 2;
            var mainSide = side * MAIN_OVERLAY_SCALE;
            var innerSide = side * INNER_OVERLAY_SCALE;
            var mainRadius = Math.min(borderRadiusPx, mainSide / 2);
            var innerRadius = Math.min(borderRadiusPx, innerSide / 2);
            graphics.fillStyle(Color.hex("".concat(baseColor, "-600")), 1);
            graphics.fillRoundedRect(centerX - mainSide / 2, centerY - mainSide / 2, mainSide, mainSide, mainRadius);
            graphics.fillStyle(Color.hex("".concat(baseColor, "-500")), INNER_OVERLAY_OPACITY);
            graphics.fillRoundedRect(centerX - innerSide / 2, centerY - innerSide / 2, innerSide, innerSide, innerRadius);
            graphics.generateTexture(textureKey, textureSize, textureSize);
            graphics.destroy();
            return textureKey;
        };
        IconButton.prototype.createIconText = function (scene, icon, size, baseColor) {
            this.iconText = new IconText({
                scene: scene,
                x: 1,
                y: 1,
                ...
                style: {
                    ...
                    strokeThickness: 3,
                    stroke: Color.rgb("".concat(baseColor, "-900")),
                },
            });
            this.iconText.setFontStyle('900');
            this.iconText.setOrigin(0.5, 0.5);
        };
        IconButton.prototype.setupContainer = function () {
            this.add([this.shadowSprite, this.backgroundSprite, this.iconText]);
        };
        IconButton.prototype.setupInteractivity = function (onClick) {
            var _this = this;
            this.backgroundSprite.setInteractive({ useHandCursor: true });
            this.backgroundSprite.on('pointerover', function () {
                _this.scene.tweens.add({
                    targets: _this.iconText,
                    scale: HOVER_SCALE$1,
                    duration: durations$1.hover,
                    ease: 'Linear',
                });
            });
            this.backgroundSprite.on('pointerout', function () {
                _this.scene.tweens.add({
                    targets: _this.iconText,
                    scale: 1,
                    duration: durations$1.hover,
        ...
        Object.defineProperty(IconButton.prototype, "interactive", {
            /**
             * Gets the interactive sprite of the icon button
             * @returns The interactive sprite
             */
         ...
         * @returns Rectangle with the button bounds
         */
        IconButton.prototype.getBounds = function (output) {
            var _a, _b;
            var width = (_a = this.shadowSprite.displayWidth) !== null && _a !== void 0 ? _a : this.shadowSprite.width;
            var height = (_b = this.shadowSprite.displayHeight) !== null && _b !== void 0 ? _b : this.shadowSprite.height;
            if (output) {
                return output.setTo(this.x - width / 2, this.y - height / 2, width, height);
            }
            return new Phaser.Geom.Rectangle(this.x - width / 2, this.y - height / 2, width, height);
    ...
    var A_HUNDRED$1 = 100;
    var INDETERMINATE_ANIMATION_DURATION = 1500; // 1.5 seconds
    var LinearProgress = /** @class */ (function (_super) {
        __extends(LinearProgress, _super);
        function LinearProgress(_a) {
            var scene = _a.scene, x = _a.x, y = _a.y, width = _a.width, height = _a.height, _b = _a.backgroundColor, backgroundColor = _b === void 0 ? 'gray-200' : _b, _c = _a.progressColor, progressColor = _c === void 0 ? 'blue-500' : _c, _d = _a.borderRadius, borderRadius = _d === void 0 ? 'default' : _d, _e = _a.progress, progress = _e === void 0 ? 0 : _e, _f = _a.indeterminate, indeterminate = _f === void 0 ? false : _f, _g = _a.indeterminateAnimationDuration, indeterminateAnimationDuration = _g === void 0 ? INDETERMINATE_ANIMATION_DURATION : _g;
            var _this = _super.call(this, scene, x, y) || this;
            _this.pw = getPWFromScene(scene);
            _this.progressWidth = width;
            _this.progressHeight = height;
            _this.backgroundColor = backgroundColor;
            _this.progressColor = progressColor;
            _this.currentProgress = Math.max(0, Math.min(A_HUNDRED$1, progress));
            _this.isIndeterminate = indeterminate;
            _this.indeterminateAnimationDuration = indeterminateAnimationDuration;
            _this.borderRadiusPx =
                typeof borderRadius === 'number'
                    ? borderRadius
                    : _this.pw.radius.px(borderRadius);
            _this.createBackgroundSprite();
            _this.createProgressSprite();
            _this.setupContainer();
         ...
         */
        LinearProgress.prototype.setProgress = function (progress, animate) {
            var _this = this;
            if (animate === void 0) { animate = true; }
            if (this.isIndeterminate) {
                return this;
            }
            var newProgress = Math.max(0, Math.min(A_HUNDRED$1, progress));
         ...
         */
        LinearProgress.prototype.getProgress = function () {
         ...
         */
        LinearProgress.prototype.setIndeterminate = function (indeterminate) {
         ...
         */
        LinearProgress.prototype.setBorderRadius = function (borderRadius) {
            var newRadiusPx = typeof borderRadius === 'number'
                ? borderRadius
                : this.pw.radius.px(borderRadius);
            if (this.borderRadiusPx === newRadiusPx) {
         ...
         */
        LinearProgress.prototype.setBackgroundColor = function (color) {
         ...
         */
        LinearProgress.prototype.setProgressColor = function (color) {
         ...
         */
        LinearProgress.prototype.destroy = function () {
            this.stopIndeterminateAnimation();
            _super.prototype.destroy.call(this);
        };
        LinearProgress.prototype.createBackgroundSprite = function () {
        ...
        LinearProgress.prototype.createProgressSprite = function () {
        ...
        LinearProgress.prototype.setupContainer = function () {
            this.add([this.backgroundProgressBar, this.progressBar]);
        };
        LinearProgress.prototype.calculateProgressDimensions = function () {
            var progressWidth = (this.progressWidth * this.currentProgress) / A_HUNDRED$1;
            var leftOffset = (progressWidth - this.progressWidth) / 2;
            return { progressWidth: progressWidth, leftOffset: leftOffset };
        };
        LinearProgress.prototype.updateProgressBar = function (force) {
            if (force === void 0) { force = false; }
            if (this.isIndeterminate && !force) {
                return;
            }
            var _a = this.calculateProgressDimensions(), progressWidth = _a.progressWidth, leftOffset = _a.leftOffset;
            this.progressBar.setScale(progressWidth / this.progressWidth, 1);
            this.progressBar.setX(leftOffset);
        };
        LinearProgress.prototype.startIndeterminateAnimation = function () {
            if (!this.isIndeterminate) {
                return;
            }
            this.currentProgress = 40;
            this.updateProgressBar(true);
            var progressWidth = this.calculateProgressDimensions().progressWidth;
            ...
            var maxX = (this.progressWidth / 2) - (progressWidth / 2);
            var minX = -(this.progressWidth / 2) + (progressWidth / 2);
            // Start from the left
        ...
        LinearProgress.prototype.stopIndeterminateAnimation = function () {
            if (this.indeterminateAnimation) {
                this.indeterminateAnimation.destroy();
                this.indeterminateAnimation = undefined;
            }
        };
        LinearProgress.prototype.recreateSprites = function () {
            // Remove old sprites
         ...
         */
        LinearProgress.prototype.getEffectiveBorderRadius = function () {
            var maxRadius = Math.min(this.progressWidth, this.progressHeight) / 2;
     ...
     */
    var SizedBox = /** @class */ (function (_super) {
        __extends(SizedBox, _super);
        /**
         * Creates a new SizedBox instance.
         * @param params SizedBoxParams
         */
        function SizedBox(_a) {
            var scene = _a.scene, x = _a.x, y = _a.y, _b = _a.width, width = _b === void 0 ? 1 : _b, _c = _a.height, height = _c === void 0 ? 1 : _c;
            ...
            var finalWidth = width !== null && width !== void 0 ? width : 1;
            var finalHeight = height !== null && height !== void 0 ? height : 1;
            // Create invisible rectangle (no fill, no stroke)
            return _super.call(this, scene, x, y, finalWidth, finalHeight, 0x000000, 0) || this;
        }
        /**
         ...
         */
        SizedBox.prototype.setWidth = function (width) {
            this.width = width;
            return this;
        };
        /**
         ...
         * @returns This SizedBox instance.
         */
        SizedBox.prototype.setHeight = function (height) {
            this.height = height;
            return this;
        };
        /**
         ...
         * @returns This SizedBox instance.
         */
        SizedBox.prototype.setSize = function (width, height) {
            this.width = width;
            this.height = height;
            return this;
        };
        return SizedBox;
    }(Phaser$1.GameObjects.Rectangle));
    ...
    var TextButton = /** @class */ (function (_super) {
        ...
        function TextButton(_a) {
            var scene = _a.scene, x = _a.x, y = _a.y, text = _a.text, fontSize = _a.fontSize, font = _a.font, _b = _a.backgroundColor, backgroundColor = _b === void 0 ? 'blue' : _b, _c = _a.textColor, textColor = _c === void 0 ? 'white' : _c, _d = _a.borderRadius, borderRadius = _d === void 0 ? 'md' : _d, _e = _a.margin, margin = _e === void 0 ? '4' : _e, onClick = _a.onClick;
            var _this = _super.call(this, scene, x, y) || this;
            _this.pw = getPWFromScene(scene);
            // Store values
            _this.textValue = text;
            _this.fontSizePx =
                typeof fontSize === 'number'
                    ? fontSize
                    : _this.pw.fontSize.px(fontSize !== null && fontSize !== void 0 ? fontSize : 'md');
            _this.marginPx =
                typeof margin === 'number'
                    ? margin
                    : _this.pw.spacing.px(margin !== null && margin !== void 0 ? margin : '4');
            ...
            _this.fontValue =
                typeof font === 'string'
                    ? font
                    : _this.pw.font.family(font !== null && font !== void 0 ? font : 'primary');
            _this.createButtonText(scene);
            _this.createShadowSprite(scene);
            _this.createBackgroundSprite(scene);
            _this.setupContainer();
            _this.setupInteractivity(onClick);
            return _this;
         ...
         * @returns This TextButton instance.
         */
        TextButton.prototype.setFontSize = function (fontSize) {
            this.fontSizePx =
                typeof fontSize === 'number'
                    ? fontSize
                    : this.pw.fontSize.px(fontSize !== null && fontSize !== void 0 ? fontSize : 'md');
         ...
         * @returns This TextButton instance.
         */
        TextButton.prototype.setFont = function (font) {
            this.fontValue =
                typeof font === 'string'
                    ? font
                    : this.pw.font.family(font !== null && font !== void 0 ? font : 'primary');
         ...
         * @returns This TextButton instance.
         */
        TextButton.prototype.setBackgroundColor = function (color) {
            this.backgroundColorValue = Color.rgb(color);
            this.regenerateSprites();
            return this;
        };
         ...
         * @returns This TextButton instance.
         */
        TextButton.prototype.setTextColor = function (color) {
            this.textColorValue = Color.rgb(color);
         ...
         * @returns This TextButton instance.
         */
        TextButton.prototype.setBorderRadius = function (borderRadius) {
            this.borderRadiusPx =
                typeof borderRadius === 'number'
                    ? borderRadius
                    : this.pw.radius.px(borderRadius !== null && borderRadius !== void 0 ? borderRadius : 'md');
         ...
         * @returns This TextButton instance.
         */
        TextButton.prototype.setMargin = function (margin) {
            this.marginPx =
                typeof margin === 'number'
                    ? margin
                    : this.pw.spacing.px(margin !== null && margin !== void 0 ? margin : '4');
         ...
         */
        TextButton.prototype.createButtonText = function (scene) {
         ...
         * @param scene Phaser scene.
         */
        TextButton.prototype.createShadowSprite = function (scene) {
            var shadowTexture = this.createShadowTexture(scene);
         ...
         * @param scene Phaser scene.
         */
        TextButton.prototype.createBackgroundSprite = function (scene) {
            var backgroundTexture = this.createBackgroundTexture(scene);
         ...
         */
        TextButton.prototype.regenerateSprites = function () {
            // Update text bounds after text/font changes
            this.buttonText.setText(this.textValue);
            // Regenerate textures
            var shadowTexture = this.createShadowTexture(this.scene);
            var backgroundTexture = this.createBackgroundTexture(this.scene);
            this.shadowSprite.setTexture(shadowTexture);
            this.backgroundSprite.setTexture(backgroundTexture);
        };
        /**
         ...
         */
        TextButton.prototype.getButtonDimensions = function () {
            var textBounds = this.buttonText.getBounds();
            var width = textBounds.width + this.marginPx * 2;
            var height = textBounds.height + this.marginPx * 2;
            return { width: width, height: height };
        };
         ...
         */
        TextButton.prototype.createShadowTexture = function (scene) {
            var _a = this.getButtonDimensions(), width = _a.width, height = _a.height;
            var textureKey = "textButton_shadow_".concat(this.backgroundColorValue, "_").concat(this.borderRadiusPx, "_").concat(width, "_").concat(height);
            // Add some padding for shadow
            var shadowPadding = 8;
            var textureWidth = width + shadowPadding * 2;
            var textureHeight = height + shadowPadding * 2;
            var graphics = scene.add.graphics();
         ...
         * @returns The texture key.
         */
        TextButton.prototype.createBackgroundTexture = function (scene) {
            var _a = this.getButtonDimensions(), width = _a.width, height = _a.height;
            var textureKey = "textButton_bg_".concat(this.backgroundColorValue, "_").concat(this.borderRadiusPx, "_").concat(width, "_").concat(height);
            // Add some padding for texture
            var padding = 8;
            var textureWidth = width + padding * 2;
            var textureHeight = height + padding * 2;
            var graphics = scene.add.graphics();
            // Limit radius to maximum possible for the button dimensions
            var maxRadius = Math.min(width / 2, height / 2);
            var effectiveRadius = Math.min(this.borderRadiusPx, maxRadius);
         ...
         */
        TextButton.prototype.setupContainer = function () {
         ...
         */
        TextButton.prototype.setupInteractivity = function (onClick) {
            var _this = this;
            this.backgroundSprite.setInteractive({ useHandCursor: true });
            // Hover effects
            this.backgroundSprite.on('pointerover', function () {
            ...
            this.backgroundSprite.on('pointerdown', function () {
                _this.scene.tweens.add({
                    targets: [_this.backgroundSprite, _this.buttonText],
                    y: CLICK_OFFSET,
        ...
        Object.defineProperty(TextButton.prototype, "interactive", {
            /**
             * Gets the interactive sprite of the icon button
             * @returns The interactive sprite
             */
    ...
    var HUDINI_KEY = 'hudini';
    /**
     * Phaser Wind Plugin class that manages theme configuration
     * @extends Plugins.BasePlugin
     */
    var HudiniPlugin = /** @class */ (function (_super) {
        __extends(HudiniPlugin, _super);
        /**
         * Creates an instance of HudiniPlugin
         * @param pluginManager - Phaser plugin manager instance
         */
        function HudiniPlugin(pluginManager) {
             ...
             */
            _this.phaserWindMappingKey = PHASER_WIND_KEY;
            return _this;
        }
        /**
         * Initializes the plugin with theme configuration
        ...
        HudiniPlugin.prototype.init = function (_a) {
             ...
             * Changing this value can break the plugin's functionality.
             */
            _c = _a.phaserWindMappingKey, 
            /**
             * @internal
             * @deprecated Do not modify this value unless you know what you're doing.
             * Changing this value can break the plugin's functionality.
             */
            phaserWindMappingKey = _c === void 0 ? PHASER_WIND_KEY : _c;
            ...
            if (!this.pluginManager.get(PHASER_WIND_KEY)) {
                var chosenTheme = theme !== null && theme !== void 0 ? theme : (darkMode ? defaultDarkTheme : defaultLightTheme);
        ...
        Object.defineProperty(HudiniPlugin.prototype, "pw", {
            /**
